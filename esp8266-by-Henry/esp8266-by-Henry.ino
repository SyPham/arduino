...
const char* ssid = "PTS";          //Tên mạng Wifi mà Socket server của bạn đang kết nối
const char* password = "20182019";  //Pass mạng wifi ahihi, anh em rãnh thì share pass cho mình với.
 
char host[] = "192.168.43.106";  //Địa chỉ IP dịch vụ, hãy thay đổi nó theo địa chỉ IP Socket server của bạn.
